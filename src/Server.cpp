...
// Function to find a character at the same nesting level
...
// Decomposes a pattern into smaller components
...
// Checks if a character matches a given pattern
...
// Matches the pattern at the beginning of the input string
size_t match_pattern_at_beginning(const std::string& input_line, 
                                  const std::vector<std::string>& patterns,
                                  const std::string* next_pattern,
...
// Matches pattern in the entire input line
